                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        @if($order->pickup_method === 'diantar' && $order->deliveryLocation)
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-0.5 flex items-center"><span class="mr-1">🛵</span> Diantar ke</p>
                            <p class="font-extrabold text-slate-800 text-sm leading-snug">{{ $order->deliveryLocation->name }} <br><span class="text-[#005ea2] font-semibold">(Terminal {{ $order->deliveryLocation->terminal }})</span></p>
                        @else
                            <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-0.5 flex items-center"><span class="mr-1">🏃</span> Ambil Sendiri di</p>
