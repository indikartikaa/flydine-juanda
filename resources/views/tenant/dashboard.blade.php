...
<section class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div class="space-y-4">
            ...
            <form action="{{ route('tenant.settings.delivery') }}" method="POST" x-data="{ deliveryActive: {{ !is_null($tenant?->delivery_fee) ? 'true' : 'false' }} }">
                @csrf
                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2">Layanan Antar (Porter)</p>
